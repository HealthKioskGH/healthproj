    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialization', models.CharField(blank=True, max_length=100, null=True, default='')),
                ('license_number', models.CharField(blank=True, max_length=50, null=True, default='')),
                ...
                ('assigned_doctor', models.ForeignKey('self', blank=True, null=True, on_delete=models.SET_NULL, related_name='assigned_patients', limit_choices_to={'user_type': 'doctor'})),
