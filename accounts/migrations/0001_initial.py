    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('patient', 'Patient'), ('doctor', 'Doctor'), ('admin', 'Admin')], max_length=10, default='patient')),
                ('specialization', models.CharField(max_length=100, null=True, blank=True, default=None)),
                ('license_number', models.CharField(max_length=50, null=True, blank=True, default=None)),
